...
import { Printer, Archive, ListOrdered, BarChart3, Cloud, Settings, Sun, Moon, Monitor, ChevronLeft, ChevronRight, Keyboard, Github, ArrowUpCircle, Wrench, FolderKanban, FolderOpen, X, Menu, Info, Plug, Bug, LogOut, Key, Loader2, Disc3, ShieldAlert, Globe, Cpu, type LucideIcon } from 'lucide-react';
...
export const defaultNavItems: NavItem[] = [
  ...
  { id: 'devices', to: '/devices', icon: Cpu, labelKey: 'nav.devices' },
